...
def parse_args():
    ...
    parser.add_argument("-p", "--protocol",
                            ...
                            " ltp - 2x bursts 100Hz 1s with 1s interburst interval\n"
                            " ltd - 1Hz 900s\n"
                            )
    parser.add_argument("-aC", "--aicdchannels", help="How much AICD in channels [0-1]", default="0")
    parser.add_argument("-aN", "--aicdnr2b", help="How much AICD for NR2B [0-4]", default="1")
    parser.add_argument("-n2b", "--nr2bmult", help="GluN2B multiplier", default="1")    
    parser.add_argument("-b", "--beta", help="How much Beta Amyloids [0-1]", default="0")
    parser.add_argument("-bM", "--beta_midpoint", help="Beta Amyloids LTP hill midpoint multiplier", default="1")
